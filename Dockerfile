...
RUN if [ "$PRELOAD_MODELS" = "true" ]; then \
    ...
    python3 -c "from transformers import AutoImageProcessor, TableTransformerForObjectDetection; \
    ...
    echo "Skipping model pre-download (PRELOAD_MODELS=false)"; \
fi
