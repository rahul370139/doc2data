...
PURPOSE: Aligns scanned CMS-1500 page to canonical template space. Uses
dropout-red masking, AKAZE/ORB + RANSAC homography, quad fallback. No ML
training. Returns aligned image and homography for zone-based OCR.

USE CASE: Called by template_alignment agent for Lane C (scanned forms).
Use get_cms1500_registrar().register(image) to align a single page.
"""
